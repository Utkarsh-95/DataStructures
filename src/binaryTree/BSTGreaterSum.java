...
//            System.out.print(presentNode.getValue() + " ");
            presentNode.setValue(hm.get(presentNode.getValue()));
    ...
    public static void main(String args[]) {
        ...
        tree.root.left.setLeft(new BinaryNode(0));
        tree.root.left.setRight(new BinaryNode(2));
        tree.root.left.getRight().setRight(new BinaryNode(3));
