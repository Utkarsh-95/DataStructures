...
public class BinaryTreeByLinkedList {
    ...
    void insert(int value) {
        ...
        if (root == null) {
            root = node;
            System.out.println("Successfully inserted new node at Root !" + node.getValue());
            return;
        }
    ...
    void deleteNodeOfBinaryTree(int value) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (presentNode.getValue() == value) {
                ...
                System.out.println("Deepest Value " + getDeepestNode().getValue());
//                DeleteDeepestNode();
                deleteDeepest(root, 0, null, getDeepestNode().getValue());
