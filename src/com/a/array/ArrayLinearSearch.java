...
public class ArrayLinearSearch {
	public static void main(String args[]) {
		...
		System.out
				.println("Does the array contain the element 4? - " + ArrayLinearSearch.linearSearch(array, length, 4));
		System.out.println(
				"Does the array contain the element 30? - " + ArrayLinearSearch.linearSearch(array, length, 30));
